...
public class WebTable_StepDefinitions {
    ...
    public void user_is_on_the_login_page_of_web_table_app() {
        ...
        // ConfigurationReader get the value from configuration.properties from web.table.url
...
//        webTableLoginPage.loginButton.click();
        ...
        //we can call our "login" utility method and pass values from Map(in Java)
...
//        System.out.println("credentials.get(\"password\") = " + credentials.get("password"));
    ...
    @And("usr enter password {string}")
    public void usrEnterPassword(String arg0) {
    }

    @When("user enter username {string} password {string} and login")
    public void userEnterUsernamePasswordAndLogin(String arg0, String arg1) {
