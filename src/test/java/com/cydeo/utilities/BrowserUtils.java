...
//    public static void verifyURLContains(String expectedURLTitle){
//
//    Assert.assertTrue(Driver.getDriver().getCurrentUrl().contains(expectedURLTitle));
//    }

    /**
     * This method will accept a dropdown as a WebElement and return all the options text
     * in a List of String
     * @param dropDownElement
     * @return
     */
